...
/*
** Never modify these fields directly 
*/
typedef struct {
  node_t *head;
  node_t *tail;
...
/*
** A linked list should be initialized with this macro :
** linked_list_t list = new_list(Type);
** with Type being the type of the 'data' field of a node_t
*/
